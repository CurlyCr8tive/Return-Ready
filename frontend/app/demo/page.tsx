      ...
      <div className={s.content}>
        ...
        <div className={s.card}>
          <div className="mb-6 text-center">
            ...
            <p className={s.cardSub}>A weekly AI digest dashboard — built for leaders on leave</p>
          </div>
          ...
          {/* Demo badge */}
          <div className="mb-5 flex items-center gap-2 rounded-lg border border-teal-500/25 bg-teal-500/10 px-3 py-2">
        ...
        <p className="mt-6 text-center text-xs text-slate-600">
          Built by <span className="text-slate-400 font-medium">Cherice Heron</span> · AI Product Design
        </p>
      </div>
    </div>
  )
